...
class J {
    public static void main(String[] args) {
        ...
        map.put(new Student("vyom", 24), new College("GGCT"));
        map.put(new Student("ehom", 19), new College("Global"));
        map.put(new Student("tom", 23), new College("SGBM"));
        map.put(new Student("nom", 17), new College("SRIT"));
        map.put(new Student("qom", 19), new College("HCET"));
                 
        Student x = new Student("pom", 22);
        Student theKey = map.ceilingKey(x);
